      ...
      <div className="container max-w-4xl px-4 text-center">
        ...
        >
          <span className="relative flex h-2 w-2">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-400/70"></span>
        ...
        >
            Sua empresa pode ser pioneira, faça o cadastro e tenha acesso antes que o concorrente.
